...
public class TraditionalFormatter : IWhoisFormatter
{
    ...
    private static readonly Dictionary<string, string[]> DomainFieldMappings = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["expires"] = ["Registry Expiry Date:", "Expiration Date:", "Expires:", "Expiry Date:", "Registrar Registration Expiration Date:", "Domain Expiration Date:", "Expiration Time:", "Record expires on:", "Record expires:", "Expiration:", "Expiry Date:", "expires:"],
